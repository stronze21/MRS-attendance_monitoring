                ...
                <tbody>
                    @forelse ($teachers as $teacher)
                        <tr class="hover">
                            ...
                            <td>
                                <button class="btn btn-sm btn-primary" wire:key='select-teacher-{{ $teacher->id }}'
        ...
        <div class="flex flex-col space-y-2 col-span-12 lg:col-span-4 bg-white rounded-md p-2 h-full">
            <div class="grid grid-cols-12 gap-2">
                ...
                <div class="form-control w-full col-span-12 xl:col-span-12">
                    ...
                    <input type="text" class="input input-sm input-bordered w-full" wire:model='teacher_id' />
                    @error('teacher_id')
                ...
                <div class="form-control w-full col-span-12 xl:col-span-4">
                    ...
                    <input type="date" class="input input-sm input-bordered w-full" wire:model='appointment_date' />
