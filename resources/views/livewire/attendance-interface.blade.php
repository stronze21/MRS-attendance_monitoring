    ...
    <div class="grid justify-center w-full h-screen grid-cols-12 gap-5 mt-2 overflow-x-auto">
        <div class="flex flex-col h-full col-span-12 p-2 space-y-2 bg-white rounded-md xl:col-span-5 2xl:col-span-4">
            ...
            <div class="flex space-x-2">
                <input type="text" id="id_no" class="w-full input input-lg input-bordered input-primary"
                    placeholder="ID #" wire:model.live.debounce.150ms="id_no" />
                <button class="btn btn-lg btn-primary" wire:click='time_in()'>
                    Manual Log
                </button>
            </div>
            ...
            <table class="hidden w-full border table-xs sm:table">
                ...
                <tbody>
                    @forelse ($attendances as $attendance)
                        <tr class="hover">
                            <th class="border">
                                {{ $for_user == 'student' ? $attendance->student_id : $attendance->teacher_id }}</th>
                            <td class="border">
                                {{ $for_user == 'student' ? $attendance->student->fullname() : $attendance->teacher->fullname() }}
                            </td>
